# 国内如何使用 ChatGPT？最容易懂的 ChatGPT 说明与教学指南
---
>更新时间: 2025-09-20  
...
| 网站名称               | 支持功能                                 | 类型              | 访问方式                                                                                                      |
|------------------------|------------------------------------------|-------------------|---------------------------------------------------------------------------------------------------------------|
| 一下AI                 | GPT-5、GPT o1、AI绘画、AI翻译            | 网站              | [xsimplechat.com](http://xsimplechat.com)                                                                     |
| Lify Chat              | GPT-5、GPT4.0 turbo、GPT o1、AI PPT、插件 | 网站              | [ai.lanjingai.org](http://ai.lanjingai.org)                                                                          |
...
1. **选择镜像站点**：访问推荐的镜像站点，如 ai.lanjingai.org。
2. **注册账号**：使用您的邮箱或手机号完成注册。
3. **选择模型**：根据需要选择 GPT-5、GPT-3.5 或 GPT-o1。
